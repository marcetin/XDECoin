...
// XDE: total coins staked (non-spendable until maturity)
...
// XDE: check 'spent' consistency between wallet and txindex
// XDE: fix wallet spent state according to txindex
...
// XDE: disable transaction (only for coinstake)
